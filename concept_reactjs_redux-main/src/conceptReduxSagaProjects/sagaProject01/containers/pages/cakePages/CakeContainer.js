    ...
    render() {
        return (
            <div>
                ...
                <button onClick={() => { this.handleAddCake(1) }} >Add 1 Cake (async action)</button>
                <button onClick={() => { this.handleAddCake(2) }}>Add 2 cake (async action)</button>
            </div>
        )
    }
}
...
const mapStateToProps = state => {
    console.log('CakeContainer => mapStateToProps')
    return {
...
const mapDispatchToProps = dispatch => {
    console.log('CaakContainer => mapDispatchToProps')
    return {
